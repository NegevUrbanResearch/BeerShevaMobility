...
class DashboardApp:
    ...
    def setup_layout(self):
        self.app.layout = dbc.Container([
            dbc.Row([
                dbc.Col(html.H1("Beer Sheva Mobility Dashboard", className="text-center mb-4", style={'font-size': '3rem'}), width=12)
            ]),
            dbc.Row([
                dbc.Col([
                    dcc.Dropdown(
            ...
            dbc.Row([
                dbc.Col(html.Img(id='frequency-chart', src='', style={'width': '100%', 'height': 'auto'}), width=4),
                dbc.Col(html.Img(id='mode-chart', src='', style={'width': '100%', 'height': 'auto'}), width=4),
                dbc.Col(html.Img(id='purpose-chart', src='', style={'width': '100%', 'height': 'auto'}), width=4)
            ]),
            dbc.Row([
                dbc.Col(dcc.Graph(id='time-chart'), width=12)
            ])
        ], fluid=True, style={'backgroundColor': COLOR_SCHEME['background'], 'color': COLOR_SCHEME['text'], 'font-size': '1.5rem'})
